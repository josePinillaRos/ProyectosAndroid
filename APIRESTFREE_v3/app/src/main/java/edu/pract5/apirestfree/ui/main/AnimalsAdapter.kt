...
/**
 * Clase AnimalsAdapter.kt
 * Clase que se encarga de adaptar los datos de los animales a la vista.
 * @author Jose Pinilla
 *
 * @param onClickAnimalsItem Funcion que se ejecuta al hacer click en un animal.
 * @param onClickFavorite Funcion que se ejecuta al hacer click en el boton de favorito.
 */
class AnimalsAdapter (
    ...
    inner class AnimalsViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        fun bind(item: Animals) {
            ...
            binding.tvScientificName.text = item.taxonomy?.scientificName
...
/**
 * Clase AnimalsDiffCallback
 * Clase que se encarga de comparar los elementos de la lista de animales.
 * @author Jose Pinilla
 */
