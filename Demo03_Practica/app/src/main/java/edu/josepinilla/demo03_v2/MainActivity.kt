...
import edu.josepinilla.demo03_v2.databinding.ActivityMainBinding
...
class MainActivity : AppCompatActivity() {
    ...
    private lateinit var archivedFragment: FragmentArchived
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        archivedFragment = FragmentArchived()
        ...
        if (mainViewModel.fragmentShowed == null)
            ...
            when (mainViewModel.fragmentShowed) {
                ...
                archivedFragment.javaClass.simpleName -> loadFragment(archivedFragment)
            }
        }
    }
    ...
    override fun onStart() {
        ...
        binding.mBottonNavView.setOnItemSelectedListener {
            when (it.itemId) {
                ...
                R.id.op_archived -> loadFragment(archivedFragment)
            }
            true
        }
    }
