...
/**
 * CitiesAdapter
 * Clase que representa el adaptador de la lista de ciudades
 *
 * @param onCityClick función que se ejecuta al hacer clic en una ciudad
 *
 * @author Jose Pinilla
 */
class CitiesAdapter(
...
/**
 * DiffCitiesCallback
 * Clase que representa el callback para comparar ciudades
 *
 * @autor Jose Pinilla
 */
